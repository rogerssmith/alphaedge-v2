...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 76226)), "/Users/fishflow/Documents/Website Backup/Alpha Edge/new-alphaedge/alphaedge-v2/app/(admin)/admin/settings/coins/page.tsx"],
    ...
    const pages = ["/Users/fishflow/Documents/Website Backup/Alpha Edge/new-alphaedge/alphaedge-v2/app/(admin)/admin/settings/coins/page.tsx"];

    

    const originalPathname = "/(admin)/admin/settings/coins/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(admin)/admin/settings/coins/page","pathname":"/admin/settings/coins","bundlePath":"app/(admin)/admin/settings/coins/page","filename":"","appPaths":[]}}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 34268))
...
;// CONCATENATED MODULE: ./components/admin/settings/coins/AddNewCoinModal.tsx
...
const AddNewCoinModal = (props)=>{
    ...
    const addCoinHandler = async ()=>{
        try {
            setLoading(true);
            if (data.allowed === "") throw new Error("Select either yes or no for the enabled value");
            const res = await axios/* default */.Z.post("/api/coin", data);
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(ModalContainer/* default */.Z, {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            className: "flex flex-col justify-between gap-3 min-h-[400px]",
            children: [
...
/* harmony default export */ const coins_AddNewCoinModal = (AddNewCoinModal);
...
;// CONCATENATED MODULE: ./components/admin/settings/coins/CoinCard.tsx
    ...
    ${mode === "light" ? "shadow-[#d9d9d9] hover:shadow-[#c1c1c1]" : "shadow-[#5d5d5d] hover:shadow-[#7b7b7b]"}`,
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                children: /*#__PURE__*/ jsx_runtime_.jsx(index_esm/* FaCoins */.vAr, {
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "font-thin text-xs break-all",
...
/* harmony default export */ const coins_CoinCard = (CoinCard);

// EXTERNAL MODULE: ./node_modules/react-icons/ai/index.esm.js
var ai_index_esm = __webpack_require__(19722);
;// CONCATENATED MODULE: ./app/(admin)/admin/settings/coins/page.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 
...
const Page = ()=>{
    const [coins, setCoins] = (0,react_.useState)([]);
    const [loading, setLoading] = (0,react_.useState)(false);
    const [coinModal, setCoinModal] = (0,react_.useState)(false);
    const { company } = (0,useCompany/* default */.Z)();
    const primaryLightColor = company?.color.primaryLight;
    const getCoins = (0,react_.useCallback)(async ()=>{
        try {
            setLoading(true);
            const { data } = await axios/* default */.Z.get(`/api/coin`);
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        ...
        flex justify-center`,
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            !loading && coins.map((item)=>/*#__PURE__*/ jsx_runtime_.jsx(coins_CoinCard, {
                                    label: item.label,
                                    id: item._id,
                                    walletAddress: item.walletAddress
                                }, item._id)),
                            !loading && coins.length <= 0 && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                className: "flex justify-center flex-col items-center  min-h-[70vh]",
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx(ai_index_esm/* AiOutlineInbox */.kuQ, {
                                        color: primaryLightColor,
                                        size: 100
                                    }),
                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                        className: `font-semibold text-lg`,
                                        children: "No Coins Availaible"
                                    })
                                ]
                            }),
                            loading && /*#__PURE__*/ jsx_runtime_.jsx(cjs.Loader, {
                                color: primaryLightColor
                            })
                        ]
                    })
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(coins_AddNewCoinModal, {
                getCoins: getCoins,
                opened: coinModal,
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/fishflow/Documents/Website Backup/Alpha Edge/new-alphaedge/alphaedge-v2/app/(admin)/admin/settings/coins/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [3399,1437,6856,5598,4251,9336,277,6775,3679,8421,794,5780,4348,9722,5506,9616,5911,7215,2949,9866,7641,1240,4487,7105,9167,8977], () => (__webpack_exec__(20106)));

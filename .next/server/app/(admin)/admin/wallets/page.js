...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 97875)), "/Users/fishflow/Documents/Website Backup/Alpha Edge/new-alphaedge/alphaedge-v2/app/(admin)/admin/wallets/page.tsx"],
    ...
    const pages = ["/Users/fishflow/Documents/Website Backup/Alpha Edge/new-alphaedge/alphaedge-v2/app/(admin)/admin/wallets/page.tsx"];

    

    const originalPathname = "/(admin)/admin/wallets/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(admin)/admin/wallets/page","pathname":"/admin/wallets","bundlePath":"app/(admin)/admin/wallets/page","filename":"","appPaths":[]}}
...
;// CONCATENATED MODULE: ./components/admin/wallet/DeleteWalletModal.tsx




const DeleteWalletModal = (props)=>{
        ...
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            ...
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                    children: "Are you sure you want to delete this Wallet"
                }),
...
/* harmony default export */ const wallet_DeleteWalletModal = (DeleteWalletModal);
...
;// CONCATENATED MODULE: ./components/admin/wallet/WalletCard.tsx
...
const WalletCard = (props)=>{
    ...
    const [deleteModal, setDeleteModal] = (0,react_.useState)(false);
    const [loading, setLoading] = (0,react_.useState)(false);
    const deleteWalletHandler = async ()=>{
        try {
            setLoading(true);
            const { data } = await axios/* default */.Z.delete(`/api/admin/wallets/${wallet._id}`);
            if (data.error) throw new Error(data.error);
            getWallets();
            dist/* toast */.Am.success("Wallet deleted");
        } catch (error) {
    ...
    ${mode === "light" ? "shadow-[#d9d9d9] hover:shadow-[#c1c1c1]" : "shadow-[#5d5d5d] hover:shadow-[#7b7b7b]"}`,
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(wallet_DeleteWalletModal, {
                opened: deleteModal,
...
/* harmony default export */ const wallet_WalletCard = (WalletCard);
...
;// CONCATENATED MODULE: ./app/(admin)/admin/wallets/page.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 
...
const Page = ()=>{
    ...
    const getWallets = (0,react_.useCallback)(async ()=>{
        try {
            const { data } = await axios/* default */.Z.get("/api/admin/wallets");
            if (data.error) throw new Error(data.error);
            setWallets(data);
        } catch (error) {
            dist/* toast */.Am.error(error.message);
    ...
    if (!wallets) {
        return /*#__PURE__*/ jsx_runtime_.jsx("div", {
            ...
            children: /*#__PURE__*/ jsx_runtime_.jsx(cjs.Loader, {
                color: primaryLight
            })
        });
    }
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        flex justify-center`,
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    wallets.map((wallet)=>/*#__PURE__*/ jsx_runtime_.jsx(wallet_WalletCard, {
                            getWallets: getWallets,
                            wallet: wallet
                        }, wallet._id)),
                    wallets.length <= 0 && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        className: "flex justify-center flex-col items-center  min-h-[80vh]",
                        children: [
                            /*#__PURE__*/ jsx_runtime_.jsx(index_esm/* AiOutlineInbox */.kuQ, {
                                color: primaryLight,
                                size: 100
                            }),
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                className: `font-semibold text-lg`,
                                children: "No Imported Wallet Availaible"
                            })
                        ]
                    })
                ]
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/fishflow/Documents/Website Backup/Alpha Edge/new-alphaedge/alphaedge-v2/app/(admin)/admin/wallets/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [3399,1437,6856,5598,4251,9336,277,6775,3679,8421,794,5780,4348,9722,5506,9616,5911,7215,2949,9866,7641,1240,4487,9167,8977], () => (__webpack_exec__(40317)));
